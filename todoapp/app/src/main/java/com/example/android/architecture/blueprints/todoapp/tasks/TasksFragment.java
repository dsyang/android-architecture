...
import android.support.v4.widget.SwipeRefreshLayoutq;
...
public class TasksFragment extends Fragment implements TasksContract.View {
    ...
    private LithoView mTaskListView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Set up tasks view
        mTaskListView = (LithoView) root.findViewById(R.id.tasks_list);
        ...
        swipeRefreshLayout.setScrollUpChild(mTaskListView);
    ...
    public void showTasks(List<Task> tasks) {
        mTaskListView.setComponent(Tasks.create(mTaskListView.getComponentContext())
            .tasks(tasks)
